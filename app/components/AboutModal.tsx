...
export default function AboutModal({
  ...
  return (
    ...
    >
      ...
      <div className="">
        <h2 className="font-semibold w-full underline text-xl sm:text-2xl md:text-3xl lg:text-4xl subpixel-antialiased p-2">Origin Story</h2>
        <div className="">
        <p className="font-semibold text-sm sm:text-base md:text-lg lg:text-xl subpixel-antialiased p-2">
                ...
                <h3 className="text-center w-full text-lg sm:text-xl md:text-2xl lg:text-3xl subpixel-antialiased p-2">
                  The First Go
                </h3>
                <p className="font-semibold text-sm sm:text-base md:text-lg lg:text-xl subpixel-antialiased p-2">
