  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center">
        <h3 className="text-center font-normal w-full underline text-xl md:text-2xl lg:text-3xl subpixel-antialiased p-2">
          Origin Story
        </h3>
        <div className="p-6">
          <p className="font-normal text-sm sm:text-base md:text-lg lg:text-xl subpixel-antialiased p-2">
          ...
          <h4 className="text-center w-full text-base sm:text-lg md:text-xl lg:text-2xl subpixel-antialiased p-2">
            The First Go
          </h4>
          <p className="font-normal text-sm sm:text-base md:text-lg lg:text-xl subpixel-antialiased p-2">
